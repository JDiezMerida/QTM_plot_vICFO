...
class MyTableWidget(QtWidgets.QWidget):
    ...
    def openFileName(self):
        ...
        if self.fileName:
            for i in range(len(self.fileName)):
                ...
                try:
                    self.data, self.raw_data, self.variables = general_plotting_vICFO.parse_data_vICFO(self.dataset)
    ...
    def import_popup(self):
        ...
        if getattr(self.data,self.variables[0])[0]!=getattr(self.data,self.variables[0])[5]:
            ...
            self.data,self.variables2=general_plotting_vICFO.map_transform(self.dataset)
            self.dimension=2
        '''Load the initial parameters for plotting'''
        self.x_axis_box.clear()
        self.y_axis_box.clear()
    ...
    def openFileName2(self):
        ...
        if fileName:
            ...
            try:
                ...
                self.data2, self.variables2 = general_plotting_vICFO.map_transform(self.dataset2)
