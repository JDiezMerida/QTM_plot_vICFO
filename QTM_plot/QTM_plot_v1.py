...
class MyTableWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        ...
        titlebox_layout.addWidget(self.legendlabel)
    ...
    def openFileName(self):
        ...
        if self.fileName:
            for i in range(len(self.fileName)):
                ...
                try:
                    self.data, self.raw_data, self.variables = general_plotting.parse_data(self.dataset)
                    ...
                    if getattr(self.data,self.variables[0])[0]!=getattr(self.data,self.variables[0])[5]:
                        ...
                        self.data,self.variables=general_plotting.map_transform(self.dataset)
                        self.dimension=2
    ...
    def get_conduct_label(self):
        if self.conduct_box.isChecked():
            if self.dimension==1:
                self.y_label_box.setCurrentIndex(9)
            else:
                self.z_label_box.setCurrentIndex(9)
    ...
    def get_eh_label(self):
        if self.eh_box.isChecked():
            if self.dimension==1:
                self.y_label_box.setCurrentIndex(11)
            else:
                self.z_label_box.setCurrentIndex(11)
            return True
        else:
            return False
    ...
    def import_popup(self):
        ...
        if getattr(self.data,self.variables[0])[0]!=getattr(self.data,self.variables[0])[5]:
            ...
            self.data,self.variables2=general_plotting.map_transform(self.dataset)
            self.dimension=2
        '''Load the initial parameters for plotting'''
        self.x_axis_box.clear()
        self.y_axis_box.clear()
    ...
    def openFileName2(self):
        ...
        if fileName:
            ...
            try:
                ...
                self.data2, self.variables2 = general_plotting.map_transform(self.dataset2)
    ...
    def get_conduct_label2(self):
        if self.conduct_box2.isChecked():
            self.z_label_box2.setCurrentIndex(9)
            self.extent_bool2=True
    ...
    def get_eh_label2(self):
        if self.eh_box2.isChecked():
            self.z_label_box2.setCurrentIndex(11)
            self.extent_bool2=True
            self.x_label2=labels_dict[self.x_label_box2.currentText()]
            self.y_label2=labels_dict[self.y_label_box2.currentText()]
            self.z_label2=labels_dict[self.z_label_box2.currentText()]
...
class PlotCanvas(FigureCanvas):
    ...
    def plot(self,dataset,data,raw,variables,dimension,
             ...
             title,cmap,extent_bool,clear_axis=True,
...
class MyPopup_error(QtWidgets.QWidget):
    ...
    def pop_error(self,error_message):
        ...
        background=QtGui.QImage('x_y_sign.png')
        ...
        self.label.setStyleSheet('error_sign.png')
